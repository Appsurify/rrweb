// @ts-check
// Port of tests/playwright/e2e/trekbikes-highload.spec.ts for playwright-prod.config.ts
// (testDir: './e2e', no testmap.recordingOpts -> exercises the plugin's pure
// defaultRecordOptions, including inlineStylesheet: 'all').
